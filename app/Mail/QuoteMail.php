...
class QuoteMail extends Mailable //We should implement ShouldQueue here on Production
{
    ...
    public function envelope(): Envelope
    {
        if($this->data['branch'] == 'ict'){
            return new Envelope(
                ...
                subject: 'ICT Service Mail',
            );
        }
        return new Envelope(
            // from: new Address('info@bmqbuilders.com', 'BMQ Builders'),
            to: ['info@bmqbuilders.com'],
            subject: 'Construction Service Mail',
        );
    }
